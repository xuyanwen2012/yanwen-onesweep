...
// Initialize the input to random integers. Because this is higher entropy than
// the descending sequence, and becuase we do not implement short circuit
// evaluation, this tends to be significantly faster
